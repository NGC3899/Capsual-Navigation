...
from src.code.occupancy_map import OccupancyMap
from src.code.se3_control import SE3Control
from src.code.world_traj import WorldTraj
...
filename = 'test_mymap.json'
file = os.path.join('..', 'util', filename)
...
# # check the map with obstacles in personized map
